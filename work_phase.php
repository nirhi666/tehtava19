  ...
  <div class="card-body">
    ...
    <?php else: ?>
      <div class="d-flex flex-wrap align-items-center gap-2">
        <div class="text-warning">Avoin työvaihe: <strong>#<?= (int)$openPhase['id'] ?></strong> – <?= esc($openPhase['kuvaus']) ?> (alkoi <?= esc($openPhase['aloitus']) ?>)</div>
  ...
  <div class="card-body p-0">
    <table class="table table-striped mb-0">
      ...
      <tbody>
        ...
        <?php endforeach; else: ?>
          <tr><td colspan="4" class="text-center text-muted py-4">Ei työvaiheita.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
